...
FWD_INT EQU   69; 3 second delay (at 23Hz)REV_INT
REV_INT EQU   69; 3 second delay (at 23Hz)
FWD_TRN_INT  EQU   46;ond 2 sec delay (at 23Hz)
...
_Startup:;|
      ...
      BSET  DDRA,%00000011; STAR_DIR, PORT_DIRN
...
NOT_REVERSE
             CMPA #ALL_STP; Else if it’s the ALL_STOP state
             BNE  NOT_ALL_STOP
...
UPDT_DISPL   MOVB  #$90,ATDCTL5; R-just., uns., sing. conv., mult., ch=0, start
            ...
            ;;;;;;;;;;;;;;;;;;...  ;same for THOUSANDS, ’.’ and HUNDREDS
             ...
             LDAA #$2E                   ;output a dot character in ASCII
             JSR putcLCD
