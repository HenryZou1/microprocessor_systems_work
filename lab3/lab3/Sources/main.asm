...
TENS RMB   1 ;10 digit
UNITS RMB   1 ;1 digit
BCD_SPARE RMB 10  ;Extra space for decimal point and string te
...
lbl MOVB  #$90,ATDCTL5;r.just., unsign., sing.conv., mult., ch0, start conv.
    ...
    BRCLR PORTAD0,$C0,bowON
    LDAA  #$31;output ’1’ if bow sw OFF
    BRA   bowOFF
bowON LDAA  #$30;output ’0’ if bow sw ON
bowOFF  JSR   putcLCD
        LDAA #$21 ;...;output a space character in ASCII
        BRCLR PORTAD0,$C0,sternON
...
; Subroutine section
initLCD
            BSET  LCD_DAT,%11110000    ; configure pins PS7,PS6,PS5,PS4 for output
            BSET  LCD_CNTR,%10010000; configure pins PE7,PE4 for output
...
*
          ...
          LDX #10;and setup for another divide 
          IDIV
          STAB HUNDREDS
          CPX #0
          BEQ CON_EXIT
